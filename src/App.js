    ...
    <div className="App">
        <main>
            ...
            {products.map((products, index) => (
                ...
                >
                    <div className="product-img">
                        <img className="img" src={products.image} alt={products.alt} />
                    </div>
                    <h2 className="product-name">{products.name}</h2>
                    <p className="description">{products.compound}</p>
                    <p className="price">{(products.price - products.price % 1000) / 1000} {products.price % 1000} ₸</p>
            ...
            {/*<div className="product" onClick={openModal}>
                <img src= {products.image} alt="Смородина миничиз"   />
                <h2>Смородина миничиз</h2>
                <p class="description">{products.compound}</p>
                <p class="price">Цена: {products.price} Т</p>
                <Modal isOpen={isModalOpen} onClose={closeModal} cake2 = {cake2} />
                <button>Добавить в корзину</button>
            </div>
            ...
            <div class="product">
                ...
                <h2>Картошка</h2>
                <p class="description">Состав: яйца, мука твердых сортов пшеницы, какао,
                разрыхлитель, сахарозаменитель, масло сливочное, молоко, кокосовое масло,
                сухое молоко, сливки 33%, шоколад горький, грецкий орех </p>
